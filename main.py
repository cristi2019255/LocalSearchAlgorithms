...
def main():
    ...
    #experiment('./Results/ILS_10_experimental_1.txt', ILS)(graph = graph, probability = 0.1 , stopping_criterion = stop_after_calls)
    ...
    #experiment('./Results/adaptive_ILS.txt', adaptive_ILS)(graph = graph, stopping_criterion = stop_after_calls, P_min = 0.1, alpha = 0.5, beta = 0.5, operators = [0.01, 0.05, 0.1, 0.15, 0.2, 0.5])
